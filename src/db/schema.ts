...
export const secondaryAngles = sqliteTable("secondary_angles", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  recordId: integer("record_id")
    .notNull()
    .references(() => alignmentRecords.id),
  saiLeftInitial: real("sai_left_initial"),
  saiLeftFinal: real("sai_left_final"),
  saiRightInitial: real("sai_right_initial"),
  saiRightFinal: real("sai_right_final"),
  saiLeftMin: real("sai_left_min"),
  saiLeftMax: real("sai_left_max"),
  saiRightMin: real("sai_right_min"),
  saiRightMax: real("sai_right_max"),
  includedAngleLeftInitial: real("included_angle_left_initial"),
  includedAngleLeftFinal: real("included_angle_left_final"),
  includedAngleRightInitial: real("included_angle_right_initial"),
  includedAngleRightFinal: real("included_angle_right_final"),
  rimRunoutFrontInitial: real("rim_runout_front_initial"),
  rimRunoutFrontFinal: real("rim_runout_front_final"),
  rimRunoutRearInitial: real("rim_runout_rear_initial"),
  rimRunoutRearFinal: real("rim_runout_rear_final"),
  trackWidthDiffInitial: real("track_width_diff_initial"),
  trackWidthDiffFinal: real("track_width_diff_final"),
  axleCenterDiffInitial: real("axle_center_diff_initial"),
  axleCenterDiffFinal: real("axle_center_diff_final"),
});
